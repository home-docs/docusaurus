...
export default function Home(): ReactNode {
  ...
  const workHistory = [
    {
      company: 'RWS Group (Formerly SDL Technologies), Bengaluru',
    ...
    // You will add older jobs here as new objects in this array
  ];
  ...
  return (
    ...
    >
      ...
      <main className={styles.resumeMainContent}>
        ...
        {/* --- Updated Work History Section --- */}
        <section className={styles.resumeSection} id="work-history">
          <Heading as="h2" className={styles.sectionHeading}>
            Work History
          </Heading>
          {workHistory.map((job, jobIndex) => ( // Assuming 'workHistory' is defined in your component
            <div key={jobIndex} className={styles.jobEntry}>
              {/* Wrapper for company name and its dates */}
              ...
              {job.roles.map((role, roleIndex) => (
                <div key={roleIndex} className={styles.jobRole}>
                  {/* Wrapper for role title and its dates */}
                  <div className={styles.entryHeader}>
                    <Heading as="h4" className={styles.roleTitle}
        ...
        {/*
          You will add more sections here for Education, Projects, etc.
